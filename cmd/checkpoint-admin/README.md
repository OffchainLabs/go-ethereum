...
```shell
go get github.com/curtis0505/arbitrum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/curtis0505/arbitrum/blob/master/params/config.go#L251).*
