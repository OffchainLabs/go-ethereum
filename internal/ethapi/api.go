...
func DoCall(ctx context.Context, b Backend, args TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, overrides *StateOverride, timeout time.Duration, globalGasCap uint64, gasEstimation bool) (*core.ExecutionResult, error) {
	...
	msg, err := args.ToMessage(globalGasCap, b.ChainConfig(), header, state)
	if err != nil {
		return nil, err
	}
...
func DoEstimateGas(ctx context.Context, b Backend, args TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, gasCap uint64) (hexutil.Uint64, error) {
	...
	vanillaGasCap := gasCap
	{
		...
		gasCap, err = args.L2OnlyGasCap(gasCap, b.ChainConfig(), header, state)
		if err != nil {
			return 0, err
		}
	}
...
func AccessList(ctx context.Context, b Backend, blockNrOrHash rpc.BlockNumberOrHash, args TransactionArgs) (acl types.AccessList, gasUsed uint64, vmErr error, err error) {
	...
	for {
		...
		msg, err := args.ToMessage(b.RPCGasCap(), b.ChainConfig(), header, statedb)
		if err != nil {
			return nil, 0, nil, err
		}
