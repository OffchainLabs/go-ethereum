...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, nil, gspecNoFork, nil, engine, vm.Config{}, nil, nil, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, nil, gspecProFork, nil, engine, vm.Config{}, nil, nil, nil)
