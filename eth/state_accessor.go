...
func (eth *Ethereum) stateAtTransaction(block *types.Block, txIndex int, reexec uint64, dmContext *deepmind.Context) (core.Message, vm.BlockContext, *state.StateDB, func(), error) {
