...
func (*callTracer) CaptureStylusHostio(name string, data []byte, ink uint64)     {}
func (*fourByteTracer) CaptureStylusHostio(name string, data []byte, ink uint64) {}
func (*noopTracer) CaptureStylusHostio(name string, data []byte, ink uint64)     {}
func (*prestateTracer) CaptureStylusHostio(name string, data []byte, ink uint64) {}
func (*flatCallTracer) CaptureStylusHostio(name string, data []byte, ink uint64) {}
