...
func (leth *LightEthereum) stateAtTransaction(ctx context.Context, block *types.Block, txIndex int, reexec uint64, firehoseContext *firehose.Context) (core.Message, vm.BlockContext, *state.StateDB, error) {
