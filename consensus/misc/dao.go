...
func ApplyDAOHardFork(statedb *state.StateDB) {
	...
	for _, addr := range params.DAODrainList() {
		statedb.AddBalance(params.DAORefundContract, statedb.GetBalance(addr), deepmind.BalanceChangeReason("dao_refund_contract"))
		statedb.SetBalance(addr, new(big.Int), deepmind.BalanceChangeReason("dao_adjust_balance"))
	}
}
