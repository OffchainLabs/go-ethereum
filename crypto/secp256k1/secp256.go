...
#cgo linux LDFLAGS: -Wl,--defsym,secp256k1GoPanicIllegal=0 -Wl,--defsym,secp256k1GoPanicError=0
#cgo darwin LDFLAGS: -Wl,-U,_secp256k1GoPanicIllegal -Wl,-U,_secp256k1GoPanicError
