...
- [release/bsc-1.0.x-dm](https://github.com/streamingfast/go-ethereum/tree/release/bsc-1.0.x-dm) - BSC fork (Binance), based on Geth `1.10.3`, latest update for this branch is `v1.1.1` ([https://github.com/binance-chain/bsc](https://github.com/binance-chain/bsc)).
