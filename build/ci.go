...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/paxosglobal/go-ethereum-arbitrum/core/rawdb", "github.com/paxosglobal/go-ethereum-arbitrum/ethdb/leveldb"},
		{"github.com/paxosglobal/go-ethereum-arbitrum/core/rawdb", "github.com/paxosglobal/go-ethereum-arbitrum/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
