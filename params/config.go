...
func (c *ChainConfig) IsSharding(num *big.Int) bool {
	return isBlockForked(c.ShardingForkBlock, num)
}
...
func (c *ChainConfig) checkCompatible(newcfg *ChainConfig, headNumber *big.Int, headTimestamp uint64) *ConfigCompatError {
	...
	if isForkBlockIncompatible(c.ShardingForkBlock, newcfg.ShardingForkBlock, headNumber) {
		return newBlockCompatError("Mini-Danksharding fork block", c.ShardingForkBlock, newcfg.ShardingForkBlock)
	}
	return nil
}
...
type Rules struct {
	...
	IsMerge, IsShanghai, isCancun, isPrague, IsSharding     bool
}
