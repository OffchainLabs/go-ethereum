...
const (
	...
	// Arbitrum: per-ChainConfig defaults; overridable via ChainConfig.MaxCodeSize/MaxInitCodeSize.
	DefaultMaxCodeSize     = MaxCodeSize     // Default maximum bytecode to permit for a contract
	DefaultMaxInitCodeSize = MaxInitCodeSize // Default maximum initcode to permit in a creation transaction and create instructions
