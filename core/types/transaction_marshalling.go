...
type txJSON struct {
	...
	Flags               *hexutil.Uint64 `json:"flags,omitempty"`               // ArbExtendedTx
...
func (t *Transaction) MarshalJSON() ([]byte, error) {
	...
	case *ArbitrumExtendedTxData:
		...
		enc.R = (*hexutil.Big)(tx.R)
		enc.S = (*hexutil.Big)(tx.S)
		enc.Flags = (*hexutil.Uint64)(&tx.Flags)
...
func (t *Transaction) UnmarshalJSON(input []byte) error {
	...
	case ArbitrumExtendedTxType:
		...
		if dec.Flags == nil {
			return errors.New("missing required field 'Flags' in transaction")
		}
		inner = &ArbitrumExtendedTxData{
			DynamicFeeTx: itx,
			Flags:        uint64(*dec.Flags),
		}
